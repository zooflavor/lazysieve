...
%%% EMIL: A JS kod nem nezne ki jobban courier betukkel mint a bash kod?
\begin{lstlisting}[basicstyle=\small, language=Java]
Math.log(x)/x
\end{lstlisting}

A szkriptben használható változó, és a szokásos vezérlőutasítások.
Pl. az iterált logaritmus egy megadása:  %%% EMIL: ne hasznalj Pl. es hasonlo roviditeseket ha nem muszaj
...
Ha az $n$ elemű minta
%%% EMIL: megint egy kis apróság. Én csak az utolsó két képletet tenném equation* (és nem align*) környezetbe, az első háromat meg sima inline math-be tenném ($(x_1, y_1), stb$... és a végén nem jól néz ki az $(x_i \in \mathbb{N}$ mert nem hagy helyet a zárójel előtt. Én talán így csinálnám: $(x_1, y_1), (x_2, y_2), \ldots, (x_n, y_n)$ (ahol $x_i \in \mathbb{N}, y_i \in \mathbb{R}$)... és a második és harmadik felsorolást hasonlóan...
