...
%%% E: ezt a cimet kicsrelnem valami "legkisebb nyerzetek"re (Numerikus pontossag a program egy mellekfunkciojanak tulajdonsaga - fura ha cimkent szerepel)
...
%%% E: Erre is lehetne hivatkozni a szovegbol.
\begin{table}[H]
...
%%% E: alapvetoen jo minden. Esetleg meg egy kis "Future work" befejezest nem akarsz irni? :)
