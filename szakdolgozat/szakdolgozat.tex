...
%%% EMIL: Tipp, itt kicsit szabadabban lehet rizsázni, történelem,
%%% prímek, rekordok (pl az összes Járai-fele rekordban használtak
%%% valamilyen szitát... nyilván nem csak azt, de azt is)... Es amit
%%% talán FONTOS lenne itt megemlíteni, az az hogy a memóriával nem
%%% jól van összehangolva a dolog, és ezert érdekes az egész.
