...
A folyamat az "Ellenőrzés" gomb megnyomásával indul.
...
\item buckets, buckets-n, buckets-inc: Eratoszthenész szitája edényekkel,
	a buckets-inc inkremetális szita, a buckets-n -ben az n helyére 1-től 8-ig
	a számrendszer bitjeit lehet megadni, pl. buckets-3 8as számrendszerben számol
...
A kiválasztott közelítés részletei az ablak jobb alsó sarkában látszódnak,
