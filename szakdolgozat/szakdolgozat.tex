...
\end{itemize}
%%% EMIL: Ez az "ezt kell, azt kell" fogalmazás, nem túl előnyös. Inkább egy saját magadnak írt TODO listának hangzik, és nem diplomamunkának... amúgy a tartalom (a teljes dolgozatban) jó.  Szóval csomó dolog csak normális kijelentő mondatba kell átfogalmazni - azaz csomó dolgot csak normális kijelentő mondatba átfogalmazol (és jó)!
