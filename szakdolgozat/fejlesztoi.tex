...
\end{tikzpicture}
\end{figure}
%%% EMIL: Az abra ne szerepeljen 2x, hivatkozz ra.
%%% EMIL: Szoval nem baj ha a fejlesztoi dokumnetacio strukturaja ugyan az mint a felhasznaloie (sot nagyon is szimpatikus az otlet), de a tartalom az ne legyen az..

A program az adatbáziskönyvtárban tárolja a szitált szegmensek tábláit, és az ezekből készült statisztikákat.
A szegmensfájlokban egy $2^{30}$ hosszú intervallum minden páratlan számához hozzá van rendelve, hogy az a szám összetett vagy prím, és minden szegmens kezdő száma kongruens $1 \pmod{2^{30}}$.
...
%%% EMIL: Ezt (kovi bekezdes) olvasd at, szerintem kicsit kusza.
