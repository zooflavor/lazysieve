...
%%% E: Igen. Vagy legalabb is nagyon le lehet roviditeni. Ide irj roviden arrol hogy a fejlesztoi reszben mirol fogsz irni... lehet kicsit hivatkozni a felhasznaloi reszre, pl leirod hogy a mintakhoz az elemi fuggvenyek linearis kombinacioanak illesztese a legkisebb negyzetek modszerevel van megoldva.
...
%%% E: Akkor ez a beszelgetes is mehet mostmar a kukaba? 

\section{Az adatbázis}

A program adatbázisa egy egyszerű könyvtár, amin keresztül a különböző programrészek kommunikálnak.
%%% E: Van nem "teljes" binaris fajl is? Vagy arra gondoltal hogy szoveget nem tarolsz benne... a siman "binaris" szerintem eleg lesz..
...
%%% E: a kovi mondato(oka)t nezd at. Az $n$ az a kezdo szam? mi az hogy ezzel van jelolve? bele van irva a faljba vagy a fileneveben szerepel. Ha filenevben van, akkor decimalis vagy hexadecimalis (az utobbi, ugye).  Es igaz ismetles lenne, de lehet nem art leirni a fajlok neveit... 
...
%%% E: mi az ideiglenes fajl neve. ugye nem eznagyonfontosnetoroldle.pdf?
...
%%% E: Szerintem ez mar kicsit felsesleges magyarazkodas (az elozo mondat) es bele lehet kotni... szoban elmondhatod a vedesnel
...
%%% E: a gzip-pelest a programon belul csinalod? vagy meghivod a gzip programot? erdemes ezt tomoriteni? kicsit konkretizalhatnad ezt hogy itt mi tortenik... es a little endian dolgot ne ird le 3x. Ha tobbszor fordul elo, akkor egyszer ird le az elejen hogy ez a default.
\begin{itemize}
...
%%% E: Kovi mondat, nem optimalizacio, hanem konnyites.
...
%%% E: miutan FELOLVASSA, be is takar es joeszjakat is kivan?
...
%%% E: milyen szamrendszert? kiderul az tetszolegesen kicsi szovegkornyezetbol?
...
%%% E: mar korabban akartam mondani, hogy programkodokat is rakhatsz be a dolgozatba. A fuggveny neveket amiket emlegetsz es erdekesnek gonolsz, vagy esetleg a PrimePosition adatszerkezet. 
...
\subsubsection{Összesítő} %%% E: A felbontast nem teljesen ertem, 3.4.2.4 gui.io, es 3.4.2.5 Osszesito, ami viszont a gui.io resze... most akkor hogy van ez? nem kellene a 2 szntet likvidalni, marmint hogy 3.2.4 legye a "gui.io", es azon belul a 3.2.4.1 legyen az Osszesito. A gui.math-nel is hasonlo problemat veltem felfedezni. 
...
%%% E: nem ket mondat ez a kovetkezo egy mondat?
...
\item a szegmens mérete szabályozható, a lehetséges értékek a kettő hatványai $2^8$-tól $2^{30}$-ig 
  %%% E: a lehhesen (felteteles?) a kovetkezo pontban es a lehetseges (kijelento) stilus mintha nem lenne egy hanga: lehessen -> lehet 
...
%%% E: na jo, ezt a longtable dolgot nem ertem. ki/mi hasznalja (rejtett alany)?, milyen/melyik eredmenyt tart nyilvan?, minnel nagyobb szamoknal?, milyen muveletet vegez el a memoriaban?, milyen kulonbozo szamok?, milyen ugyan azt a bittet?, milyen eredmeny nem olvasható vissza? lehet hogy en vagyok, hulye, de ezek a kerdesek legalabb fele nem derul ki a szovegkornyezetbol.
...
%%% E: milyen poziciokrol van itt szo? melyik kivetelevel? egy vagy ketto? milyen elemek? milyen/mi szerinti csoportositasat?
...
%%% E: mert bovitheto nehezebben primekkel... mintha ujra ugralnal nagyokat, es innen onnan kis reszleteket irkalnal ossze... vagy csak en nem tudo kovetni?

A sziták egyszerű hierarchiát alkotnak.
%%% E: mi az hogy foglalkoznak?
...
\item \texttt{SieveOfAtkin}: Atkin szitája
  %%% E: kovetkezo mondat. WTF? Vagy egy ketospontot tegyel az implementacioi utan a vesszo helyett, vagy fogalmazd at a mondatod. Eratoszthenész sztata minden implementacioja a prim-pozicio
...
%%% E: Ezt hogyan csinalod.  Ha ugy ahogy a pseudoprimebase hivatkozasban, akkor ird oda hogy "ez ugy csinalom ahogy [7]-ben csinaljak".
...
%%% E: Kovi mondat, a kivalasztott szita a referencia... nem tom, ezek a mondatok is kicsit funky-nak tunnek.  De lehet hogy csak faradt vagyok.
...
%%% E: Ez az elozo mondat nem lenne ugy szebb, hogy "ez csak akkor fordulhat elo ha egy masik szalon mar dolgozik egy uj GraphRenderer, es ami helyes viselkedest eredmenyez".
