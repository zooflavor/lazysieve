...
A szegmensfájlok ellenőrizhetőek, ehhez egy, a generator-tól különböző eratosthenészi szita, vagy az erős pszeudo-prímteszt\cite{pseudoprime} előállítja a szegmens ellenőrzött részét, és a program a kettőt összehasonlítja.
...
\end{itemize}
A három paraméter mindegyik lehetőségéhez a mérés elemi függvények függvények alapján egy mintát generál, majd ezt a mintát ugyanezekkel az elemi függvényekkel közelíti.
...
\hline
összegzés & csere & rendezett & $\sum{hiba^2}$ & idő (ns) \\ \cline{1-5}
\multirow{4}{*}{változó} & \multirow{2}{*}{részleges} & igen & $2,53 \cdot 10^{25}$ & $1,26 \cdot 10^{9}$ \\ \cline{3-5}
& & nem & $4,24 \cdot 10^{23}$ & $1,85 \cdot 10^{9}$ \\ \cline{2-5}
& \multirow{2}{*}{teljes} & igen & $2,53 \cdot 10^{25}$ & $1,34 \cdot 10^{9}$ \\ \cline{3-5}
& & nem & $4,21 \cdot 10^{23}$ & $1,82 \cdot 10^{9}$ \\ \cline{1-5}
\multirow{4}{*}{tömb} & \multirow{2}{*}{részleges} & igen & $2,62 \cdot 10^{20}$ & $1,45 \cdot 10^{9}$ \\ \cline{3-5}
& & nem & $9,75 \cdot 10^{19}$ & $2,45 \cdot 10^{9}$ \\ \cline{2-5}
& \multirow{2}{*}{teljes} & igen & $1,87 \cdot 10^{20}$ & $1,56 \cdot 10^{9}$ \\ \cline{3-5}
& & nem & $6,76 \cdot 10^{19}$ & $2,33 \cdot 10^{9}$ \\ \cline{1-5}
\multirow{4}{*}{kupac} & \multirow{2}{*}{részleges} & igen & $1,12 \cdot 10^{21}$ & $1,37 \cdot 10^{10}$ \\ \cline{3-5}
& & nem & $1,12 \cdot 10^{21}$ & $1,67 \cdot 10^{10}$ \\ \cline{2-5}
& \multirow{2}{*}{teljes} & igen & $3,12 \cdot 10^{19}$ & $1,39 \cdot 10^{10}$ \\ \cline{3-5}
& & nem & $3,12 \cdot 10^{19}$ & $1,68 \cdot 10^{10}$ \\
\hline
\end{tabular}\\

A mérés eredményéből látszik, hogy a kiválasztott minták közelítésénél:
\begin{itemize}
\item legjobb, és leglassabb választás a kupac összegzés
\item a kupac összegzés tízszer annyi időt vesz igénybe, mint a másik két lehetőség
